...
See [tests/README.md](tests/README.md) for the live browser checklist. For a release zip, run `zip -r troll-gate-extension.zip extension -x 'extension/tests/*'` and distribute the server separately. Configure the AI provider key on the server; it is intentionally never bundled in the extension.
